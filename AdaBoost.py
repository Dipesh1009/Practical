...
# For classification, create a binary target: 'good' (1) vs 'bad' (0)
# We'll define 'good' wine as having a quality score of 6 or higher
y_class = (y >= 6).astype(int)

# For regression, use the original quality score
y_reg = y
...
# AdaBoost works by combining multiple weak learners, typically decision trees.
...
# --- Part 2: AdaBoost for Regression ---
...
print("AdaBoost minimizes an exponential loss function for classification and can use linear, square, or exponential loss for regression.")
print("This is part of the training process and not typically displayed as a final single metric.")
